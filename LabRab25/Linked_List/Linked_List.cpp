// my_dec.cpp : Defines the functions for the static library.
//

#include "pch.h"
#include "framework.h"
//#include "C:\Users\avdot\Desktop\LabWorks\LabRab25\Bubble_queue\Bubble_queue.cpp"
using namespace std;
template<typename T>
class Node {
public:
...
template<typename U>
class Bubble_queue :public my_queue<U> {
public:
    void bubble_sort2() {
