...
#include <memory>
#include "../../trains_solution/adding.h"
...
QT_MOC_LITERAL(1, 7, 8), // "add_info"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 15) // "on_save_clicked"

    },
    "Adding\0add_info\0\0on_save_clicked"
};
...
void Adding::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Adding::add_info)) {
                *result = 0;
                return;
            }
        }
